...
class InteractiveTerminal {
 ...
 |_|_|||_||____/  |_|     |___| |_____|_| |_||__| |_|_|    
    ...
    this.addLine('<span class="terminal-text">  cd romantic - Navigate to romantic page</span>');
    }
    ...
    this.addLine('<span class="terminal-text">  romantic  - Special romantic page</span>');
        this.addLine('');
    ...
    cdCommand(args) {
        ...
        if (target === 'romantic') {
            this.addLine('<span class="terminal-text success">Navigating to romantic page...</span>');
            setTimeout(() => {
